...
function isComponentEnabled(tblName, actionType = 'cu') {
  const disabledDeleteTables = ["milk_collections","MilkcollectionsProfileTray","system_role_bundles", "system_users", "client_list", "affiliates", "services"];
